...
!Estimation of PMI
subroutine PMIBM3(inx,outy,sn,ni)
implicit none
...
!write(200,'(4A9)')"NO","ORD","PMI","AICp"!,"AICk","HD"
!do c2=1,ni
   !write(200,*)c2, ord(c2),pmi(c2),AIC1(c2)!,AIC2(c2),Z(c2)
!end do

write(200,*)
write(200,'(A7)')"Summary"
write(200,'(4A9)')"NO","ORD","PMI","AIC"
do c2=1,ni
