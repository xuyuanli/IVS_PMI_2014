...
!Estimation of PMI
subroutine PMIRELLP(inx,outy,sn,ni)
implicit none
...
write(202,*)
write(202,'(A7)')"Summary"
write(202,'(3A9)')"NO","ORD","PMI"
do c2=1,ni
   write(202,'(I2,X,I2,X,F6.3)')c2, ord(c2),pmi(c2)
end do


write(202,'(A8)')"By AICp:"
minAIC=minval(AIC1)
do c2=1,ni
   if (AIC1(c2)==minAIC) then
       write(202,'(A7,I2,A24)')"Input (",ord(c2),") is the turnning point."
       c4=c2
   end if
end do  
...
!write(302,'(I2,X,25(I2,X),25(F6.3,X))')c4,(ord(c2),c2=1,ni),(pmi(c2),c2=1,ni)
write(302,*)c4,(ord(c2),c2=1,ni),(pmi(c2),c2=1,ni)
