...
do c1=1,n
   ...
   do c2=1,n
      if (c2==c1) then
         ...
         if (xs(c1)>=0.0 .and. xs(c1)<=bw) then
           sum1=(xs(c2)-xs(c1))**2.0/2.0/bw**2.0
           sum2=(xs(c2)+xs(c1))**2.0/2.0/bw**2.0
...
!Estimation of PMI
subroutine PMIRKRC(inx,outy,sn,ni)
implicit none
...
do c2=1,ni
   ...
   do c3=1,ni
      if (inx(1,c3)/=-9999.0) then
          call RC(sinx,inx(1:sn,c3),sn,gin)
          do c1=1,sn
