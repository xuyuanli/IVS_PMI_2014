...
h= (4.0/(d+2.0))**(1.0/(d+4.0))*sdv*n**(-1.0/(d+4.0))    
...
!Estimation of PMI
subroutine PMIBM1(inx,outy,sn,ni)
implicit none
...
write(200,'(3A9)')"NO","ORD","PMI"
do c2=1,ni
   write(200,'(I2,X,I2,X,F6.3)')c2, ord(c2),pmi(c2)
end do
...
!write(300,'(I2,X,25(I2,X),25(F6.3,X))')c4,(ord(c2),c2=1,ni),(pmi(c2),c2=1,ni) !Adjust ord & PMI format for each problem
