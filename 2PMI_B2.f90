...
!Estimation of PMI
subroutine PMIBM2(inx,outy,sn,ni)
implicit none
...
do c2=1,ni
   ...
   do c3=1,ni
      if (inx(1,c3)/=-9999.0) then
          call GRNN(sinx,inx(1:sn,c3),sn,gin)
          do c1=1,sn
...
!Results summary (in file)
!20 write(201,*)
!write(201,'(A7)')"Summary"
!write(201,'(4A9)')"NO","ORD","PMI","AICp"!,"AICk","HD"
!do c2=1,ni
   !write(201,*)c2, ord(c2),pmi(c2),AIC1(c2)!,AIC2(c2),Z(c2)
!end do

write(201,*)
write(201,'(A7)')"Summary"
write(201,'(3A9)')"NO","ORD","PMI"
do c2=1,ni
   write(201,'(I2,X,I2,X,F6.3)')c2, ord(c2),pmi(c2)
end do


write(201,'(A8)')"By AICp:"
minAIC=minval(AIC1)
do c2=1,ni
   if (AIC1(c2)==minAIC) then
       write(201,'(A7,I2,A24)')"Input (",ord(c2),") is the turnning point."
       c4=c2
   end if
end do  
...
!write(301,'(I2,X,25(I2,X),25(F6.3,X))')c4,(ord(c2),c2=1,ni),(pmi(c2),c2=1,ni) !Adjust ord & PMI format for each problem
write(301,*)c4,(ord(c2),c2=1,ni),(pmi(c2),c2=1,ni) !Adjust ord & PMI format for each problem
